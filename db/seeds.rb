...
s1= Shoe.create({category:"Boots", price: 59.10,color: "Red"})
s2= Shoe.create({category:"Sneakers", price: 60.00,color: "Black"})
s3= Shoe.create({category:"Heels", price: 89.79,color: "Brown"})
s4= Shoe.create({category:"Boots", price: 75.99,color: "Black"})
s5= Shoe.create({category:"Sneakers", price: 59.75,color: "Blue"})
s6= Shoe.create({category:"Sneakers", price: 69.00,color: "Yellow"})
s7= Shoe.create({category:"Heels", price: 39.75,color: "Black"})
s8= Shoe.create({category:"Boots", price: 70.99,color: "Brown"})
s9= Shoe.create({category:"Heels", price: 99.00,color: "Blue"})
s10= Shoe.create({category:"Sneakers", price: 49.75,color: "Blue"})
